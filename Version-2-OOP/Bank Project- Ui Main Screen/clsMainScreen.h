...
#include "BankProject-Ui TransActions Screen/clsTransActionsMenueScreen.h"
#include "BankProject-Ui Manage Users Screen/clsManageUsersScreen.h"
...
private:
    ...
    {
        //    cout <<"Change Currency Screen Will be here ";
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
        switch (MainMenueOption)
        {
            ...
            case enMainMenueOptions::eCurrencyExcahnge:
                system("cls");
